    ...
    : NeutralRole(cppPtr), ITownOfUsRole, IWikiDiscoverable, IDoomable, ICrewVariant
{
    ...
    public Color RoleColor => MiraOverloadedColors.Sentinel;
    ...
    public override void Initialize(PlayerControl player)
    {
        ...
        if (Player.AmOwner)
        {
            ...
            HudManager.Instance.ImpostorVentButton.buttonLabelText.SetOutlineColor(MiraOverloadedColors.Sentinel);
        }
    }
