    ...
    : NeutralRole(cppPtr), ITownOfUsRole, IWikiDiscoverable, IDoomable
{
    ...
    public Color RoleColor => MiraOverloadedColors.Baiter;
    ...
    public override void Initialize(PlayerControl player)
    {
        ...
        if (Player.AmOwner)
        {
            ...
            HudManager.Instance.ImpostorVentButton.buttonLabelText.SetOutlineColor(MiraOverloadedColors.Baiter);
        }
    }
    ...
    [MethodRpc((uint)MiraOverloadedRpc.BaiterReportBait)]
    ...
    [MethodRpc((uint)MiraOverloadedRpc.BaiterDestroyBait)]
    ...
    [MethodRpc((uint)MiraOverloadedRpc.BaiterFooled)]
