    ...
    : ImpostorRole(cppPtr), ITownOfUsRole, IWikiDiscoverable
{
    ...
    public Color RoleColor => MiraOverloadedColors.Arbiter;
    ...
    public override void Initialize(PlayerControl player)
    {
        ...
        if (Player.AmOwner)
        {
            ...
            Coroutines.Start(MiscUtils.CoMoveButtonIndex(CustomButtonSingleton<ArbiterSpeedButton>.Instance,
                !OptionGroupSingleton<ArbiterOptions>.Instance.CanVent));
            HudManager.Instance.ImpostorVentButton.buttonLabelText.SetOutlineColor(MiraOverloadedColors.Arbiter);
    ...
    private void UpdateDurationText()
    {
        ...
        if (_invisText == null)
        {
            ...
            _invisText.color = MiraOverloadedColors.Arbiter;
        }
        ...
        if (_speedText == null)
        {
            ...
            _speedText.color = MiraOverloadedColors.Arbiter;
        }
    ...
    [MethodRpc((uint)MiraOverloadedRpc.ArbiterSetTarget)]
