    ...
    : ImpostorRole(cppPtr), ITownOfUsRole, IWikiDiscoverable
{
    ...
    public Color RoleColor => MiraOverloadedColors.Ninja;
    ...
    public override void Initialize(PlayerControl player)
    {
        ...
        if (Player.AmOwner)
        {
            ...
            Coroutines.Start(MiscUtils.CoMoveButtonIndex(CustomButtonSingleton<NinjaAssassinateButton>.Instance,
                !OptionGroupSingleton<NinjaOptions>.Instance.CanVent));
            HudManager.Instance.ImpostorVentButton.buttonLabelText.SetOutlineColor(MiraOverloadedColors.Ninja);
        }
    }
    ...
    private void UpdateInvisText()
    {
        ...
        if (_invisText == null)
        {
            ...
            _invisText.color = MiraOverloadedColors.Ninja;
        }
    ...
    [MethodRpc((uint)MiraOverloadedRpc.NinjaSetTarget)]
    ...
    [MethodRpc((uint)MiraOverloadedRpc.NinjaAssassinate)]
