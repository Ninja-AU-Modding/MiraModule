...
public static class HiveMindDeathPatch
{
    ...
    public static void RpcHiveMindDeath(PlayerControl sender)
    {
        ...
        SoundManager.Instance.PlaySound(MiraOverloadedAudio.HiveMindDeath.LoadAsset(), false, 1f);
    ...
    public static void RpcHiveMindKill(PlayerControl sender)
    {
        ...
        SoundManager.Instance.PlaySound(MiraOverloadedAudio.HiveMindKilled.LoadAsset(), false, 1f);
