    ...
    : CrewmateRole(cppPtr), ITownOfUsRole, IWikiDiscoverable
{
    ...
    public Color RoleColor => MiraModuleColors.InspectorGeneral;
    ...
    [MethodRpc((uint)MiraModuleRpc.InspectorGeneralConvert)]
    ...
    [MethodRpc((uint)MiraModuleRpc.InspectorGeneralStrike)]
