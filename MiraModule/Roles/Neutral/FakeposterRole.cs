...
public sealed class FakeposterRole(IntPtr cppPtr) : NeutralRole(cppPtr), ITownOfUsRole, IWikiDiscoverable, IDoomable
{
    ...
    {
        CanUseVent = OptionGroupSingleton<FakeposterOptions>.Instance.CanVent,
        IntroSound = TouAudio.OtherIntroSound,
        Icon = RoleIcons.Fakeposter,
        GhostRole = (RoleTypes)RoleId.Get<NeutralGhostRole>()
    };

    public bool HasImpostorVision => OptionGroupSingleton<FakeposterOptions>.Instance.ImposterVision;
    ...
    {
        var kill = CustomButtonSingleton<FakeposterKillButton>.Instance;
        var canVent = OptionGroupSingleton<FakeposterOptions>.Instance.CanVent || LocalSettingsTabSingleton<TownOfUsLocalSettings>.Instance.OffsetButtonsToggle.Value;
    ...
    public override void Initialize(PlayerControl player)
    {
        ...
        if (Player.AmOwner)
        {
            ...
            HudManager.Instance.ImpostorVentButton.buttonLabelText.SetOutlineColor(MiraModuleColors.Fakeposter);
        }
    }
