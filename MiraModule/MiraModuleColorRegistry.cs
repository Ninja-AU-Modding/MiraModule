...
public static class MiraModuleColorRegistry
{
    ...
    private static readonly Dictionary<StringNames, MiraModuleRainbowDef> RainbowMap = [];
    ...
    public static bool TryGetRainbow(StringNames name, out MiraModuleRainbowDef def)
    {
        EnsureInitialized();
    ...
    public static void EnsureInitialized()
    {
        ...
        foreach (var def in MiraModulePlayerColors.ColorDefs)
        {
            ...
            var isGradient = def.Blend == MiraModuleColorBlend.Gradient && def.Colors.Length > 1;
        ...
        foreach (var def in MiraModulePlayerColors.RainbowDefs)
        {
